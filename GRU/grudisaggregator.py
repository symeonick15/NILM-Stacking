...
class GRUDisaggregator(Disaggregator):
    ...
    def train_across_buildings_chunk_3(self, mainchunks, meterchunks, epochs, batch_size):
        '''Train using only one chunk of data. This chunk consists of data from
        all buildings.
        ...
        self.model.fit(X_batch_total, Y_batch_total, batch_size=batch_size, epochs=epochs, shuffle=True)
    ...
    def disaggregate(self, mains, output_datastore, meter_metadata, **load_kwargs):
        ...
        **load_kwargs : key word arguments
        ...
        if data_is_available:
            self._save_metadata_for_disaggregation_custom(
